...
public class FollowerListModel implements Serializable{

    @SerializedName("follwers")
    @Expose
    private List<Follwer> follwers = null;

    public List<Follwer> getFollwers() {
        return follwers;
    }

    public void setFollwers(List<Follwer> follwers) {
        this.follwers = follwers;
    }

    public class Follwer implements Serializable {

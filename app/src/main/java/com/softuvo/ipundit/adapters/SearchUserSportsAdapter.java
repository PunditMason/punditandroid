...
public class SearchUserSportsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    private List<UserSearchSportsModel.UserDatum> searchUserItemList;
    ...
    public SearchUserSportsAdapter(Context context, List<UserSearchSportsModel.UserDatum> searchUserItemList, ItemClickListener itemClickListener) {

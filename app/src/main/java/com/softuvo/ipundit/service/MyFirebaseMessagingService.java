...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        Log.e("notificationnew", remoteMessage.toString());
        ...
        String id="";
        if(remoteMessage.getNotification().getBody()!=null){
            id=remoteMessage.getNotification().toString();

        }
        id=remoteMessage.getData().get("user_id");
    ...
    private void sendNotification(String title, String message,String id) {
        ...
        Intent intent = new Intent(this, PunditsProfileActivity.class);
        intent.putExtra("userComingFrom","pushNotification");
